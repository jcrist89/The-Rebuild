  ...
  return (
    <main className="auth-page">
      <section className="auth-card access-card">
        ...
        <p className="auth-lead">This account is not currently enabled for The Rebuild.</p>
        ...
        <div className="access-actions">
          ...
          <a className="auth-secondary" href="mailto:support@joncristfit.com?subject=Rebuild%20access">Contact support</a>
